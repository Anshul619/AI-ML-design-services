...
|             | Description                                                                                                                                                                                                              |
|-------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Temperature | This parameter controls the randomness or creativity of the model's output. <br/>- A higher temperature makes the output more diverse and unpredictable<br/>- A lower temperature makes it more focused and predictable. |
...
|               | Description                                                                                                                                                                                                                                                                 |
|---------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Max Tokens    | It determines the maximum number of tokens that the model can generate during the inference process.<br/>- This parameter helps to prevent the model from generating excessive or infinite output, which could lead to resource exhaustion or undesirable behavior.         |
