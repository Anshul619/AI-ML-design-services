# MCP vs RAG
- [RAG](../Context-Engineering/RAG.md) is like a component you could use within an MCP system, but MCP is broader - it defines how all context is structured, updated, and delivered to the model.
